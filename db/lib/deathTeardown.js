...
// the role, then hand over the Deadchat seat (db/lib/deadchat.js — a
...
const { deleteGuildRole, getGuildMember } = require("./discordRest");
...
// reborn character seconds before this would otherwise ghost them or lock them out.
