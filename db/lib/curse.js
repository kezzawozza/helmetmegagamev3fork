...
// web/lib/characterCreation.js's CURSED_ROLE_SLUGS/CURSED_POINT_PENALTY). NOT the ghost seat
// (db/lib/ghostAccess.js, a Discord role). `cursed(player) := most recent body still lying in the
