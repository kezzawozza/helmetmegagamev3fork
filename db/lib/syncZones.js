...
//
// This is a thin barrel: the actual work lives in db/lib/syncZones/, split
// along the pass boundaries this file used to hold in one file —
// parse.js (Pass 0: parse + validate), bodies.js (starter/anchor text),
// roomThreads.js (Room threads + Location anchors), ordering.js (channel
// ordering) and sync.js (the sync itself, Pass 1-5, plus the refresh
// helpers). shared.js holds the few helpers more than one of those needs.
