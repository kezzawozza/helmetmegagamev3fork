...
import { useDmState, seedNewestOutbound } from "./dmStore";
...
import { useNotified, clearNotified, clearAllNotified } from "./notifiedStore";
...
export default function Chat({
  ...
  // The live stream, now ./useFeedStream.js. It was 270 lines of EventSource
  // in the middle of this component's layout; the rebuilt chat needs the same
  // connection, and a second copy of it would drift from this one within a
  // month (CHAT-REBUILD.md).
  useFeedStream({
    mountSeq,
    self,
    selectedRef,
